...
<body>
<form method="POST" action="../controladores/ctrl_alumnos_ingresar.php" >
...
<input  type="text" placeholder="Ingresa el nombre del estudiante" name="nombre" id="nombre" onkeypress="return soloLetras(event)" required>
</p>
<p>
...
<input  type="text" placeholder="Ingresa la letra del curso" name="letraCurso" id="letraCurso" onkeypress="return soloLetras(event)" maxlength="1" minlength="1" required>
</p
<center>
<p>
...
<p>
<center> <label for="text">Tutor</label> </center>
...
<center>
<input type="submit" name="go" id="go" value="Ingresar Alumno"> <br><br>
